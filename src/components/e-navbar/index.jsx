			...
			<section className="flex items-center relative py-3 lg:px-10 px-4 border-gray-200 border-b bg-white lg:min-h-[70px] max-lg:min-h-[60px]">
				<a href="#" className="shrink-0 max-sm:hidden">
					<img
						...
						alt="logo"
						className="sm:w-[40px] w-32"
					/>
                    {/* /logo/delivea-logo4.png */}
				</a>
			...
			>
				...
				<ul className="lg:flex lg:flex-wrap lg:items-center lg:justify-center px-10 py-3 bg-[#333] min-h-[46px] gap-4 max-lg:space-y-4 max-lg:fixed max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-lg max-lg:overflow-auto z-50">
					...
					<li className="max-lg:border-b max-lg:py-3 px-3">
						<Link
							href="/"
							className={`hover:text-yellow-300 text-white ${pathe === "/" && "text-yellow-300"}  text-[15px] font-medium block`}
						>
							Home
						</Link>
					</li>
					<li className="max-lg:border-b max-lg:py-3 px-3">
						<Link
							href="/t_shirts"
							className={`hover:text-yellow-300 text-white ${pathe === "/t_shirts" && "text-yellow-300"}  text-[15px] font-medium block`}
						>
							T-Shirts
						</Link>
					</li>
					<li className="max-lg:border-b max-lg:py-3 px-3">
						<Link
							href="/hoodies"
							className={`hover:text-yellow-300 text-white ${pathe === "/hoodies" && "text-yellow-300"}  text-[15px] font-medium block`}
						>
							Hoodies
						</Link>
					</li>
